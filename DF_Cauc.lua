...
function DFS.increaseFrontSupply(coalitionId, amount)
    dfc.increaseFrontSupply({coalitionId = coalitionId, amount = amount})
end
function DFS.decreaseFrontSupply(coalitionId, amount)
    dfc.decreaseFrontSupply({coalitionId = coalitionId, amount = amount})
end
function DFS.increaseRearSupply(coalitionId, amount)
    dfc.increaseRearSupply({coalitionId = coalitionId, amount = amount})
end
function DFS.decreaseRearSupply(coalitionId, amount)
    dfc.decreaseRearSupply({coalitionId = coalitionId, amount = amount})
end
function DFS.increasePirateSupply(coalitionId, amount)
    dfc.increasePirateSupply({coalitionId = coalitionId, amount = amount})
end
function DFS.decreasePirateSupply(coalitionId, amount)
    dfc.decreasePirateSupply({coalitionId = coalitionId, amount = amount})
end
