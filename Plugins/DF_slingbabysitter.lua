...
function sbs.watchLoop(cargoName)
    ...
    if sbs.trackedCargos[cargoName] then
        ...
        if cargo then
            ...
            env.info("SBS - "..cargoName..": X: " .. sbs.trackedCargos[cargoName].lastPoint.x .. ": Z: " .. sbs.trackedCargos[cargoName].lastPoint.z .. " AGL: "..sbs.trackedCargos[cargoName].lastAGL, false)
