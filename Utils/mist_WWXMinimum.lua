--[[--
This is just MIST. I did not create this file. I took out a bunch of stuff that I don't need for WWX because there were some stability issues
with DCS aggressively garbage collecting stuff it didn't used to causing crashes with the MIST dead object DBs. I cut that out because I don't need them. 
All credit for everything in this file is solely to the creators of the wonderful MIST script. 
